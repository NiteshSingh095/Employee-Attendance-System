...
import 'package:attendance_system/UI/Authentication/fingerPrint.dart';
import 'package:attendance_system/database/database.dart';
import 'package:attendance_system/modal/user.dart';
import 'package:attendance_system/services/camera_service.dart';
import 'package:attendance_system/services/facenet_service.dart';
import 'package:attendance_system/widgets/app_button.dart';
...
Future<Users?> _predictUser() async{
  Users? userAndPass = await _faceNetService.predict();
  return userAndPass;
}
...
class _AuthActionButtonState extends State<AuthActionButton> {
  ...
  signSheet(context, Users? predictedUser) {
    return Container(
